...
//	{
//		//public static IntPtr InvalidIntPtr = new IntPtr(-1);
//		//public static IntPtr LPSTR_TEXTCALLBACK = new IntPtr(-1);
...
//		{
//			return ushort.MaxValue & lgid | (15 & sort) << 16;
//		}
...
//		//	{
//		//		return "Left = " + left + " Top " + (string)(object)top + " Right = " + (string)(object)right + " Bottom = " + (string)(object)bottom;
//		//	}
...
//		//	[MethodImpl(MethodImplOptions.PreserveSig)]
//		//	int GetPredefinedValue(int dispID, [MarshalAs(UnmanagedType.U4), In] int dwCookie, [Out] VARIANT pVarOut);
//		//}
...
//		//	{
//		//		data1 = (IntPtr)(lVal & uint.MaxValue);
//		//		data2 = (IntPtr)(lVal >> 32 & uint.MaxValue);
//		//	}

//		//	public IntPtr ToCoTaskMemPtr()
//		//	{
//		//		IntPtr ptr = Marshal.AllocCoTaskMem(16);
//		//		Marshal.WriteInt16(ptr, vt);
//		//		Marshal.WriteInt16(ptr, 2, reserved1);
//		//		Marshal.WriteInt16(ptr, 4, reserved2);
//		//		Marshal.WriteInt16(ptr, 6, reserved3);
//		//		Marshal.WriteInt32(ptr, 8, (int)data1);
//		//		Marshal.WriteInt32(ptr, 12, (int)data2);
//		//		return ptr;
//		//	}
...
//		//			case 2:
//		//				if (Byref)
//		//					num1 = (IntPtr)Marshal.ReadInt16(num1);
//		//				return (short)(ushort.MaxValue & (short)(int)num1);
//		//			case 3:
//		//			case 22:
//		//				if (Byref)
...
//		//				return (sbyte)(byte.MaxValue & (sbyte)(int)num1);
//		//			case 17:
//		//				if (Byref)
//		//					num1 = (IntPtr)((int)Marshal.ReadByte(num1));
//		//				return (byte)(byte.MaxValue & (uint)(byte)(int)num1);
//		//			case 18:
//		//				if (Byref)
//		//					num1 = (IntPtr)((int)Marshal.ReadInt16(num1));
//		//				return (ushort)(ushort.MaxValue & (uint)(ushort)(int)num1);
//		//			case 19:
//		//			case 23:
//		//				if (Byref)
//		//					num1 = (IntPtr)Marshal.ReadInt32(num1);
//		//				return (uint)(int)num1;
//		//			case 20:
//		//			case 21:
//		//				long num3 = !Byref ? (uint)((int)data1 & -1 | (int)data2) : Marshal.ReadInt64(num1);
//		//				if (vt == 20)
//		//					return num3;
//		//				return (ulong)num3;
//		//			default:
...
//		//					case 6:
//		//						return new Decimal((long)(uint)((int)data1 & -1 | (int)data2));
//		//					case 7:
//		//						throw new FormatException(SR.GetString("CannotConvertDoubleToDate"));
//		//					case 8:
//		//					case 31:
//		//						return Marshal.PtrToStringUni(num1);
//		//					case 9:
//		//					case 13:
//		//						return Marshal.GetObjectForIUnknown(num1);
//		//					case 11:
//		//						return (bool)(num1 != IntPtr.Zero ? 1 : 0);
//		//					case 12:
//		//						return ((VARIANT)UnsafeNativeMethods.PtrToStructure(num1, typeof(VARIANT))).ToObject();
//		//					case 14:
//		//						return new Decimal((long)(uint)((int)data1 & -1 | (int)data2));
//		//					case 25:
//		//						return num1;
//		//					case 29:
//		//						throw new ArgumentException(SR.GetString("COM2UnhandledVT", new object[1]
//		//						{
//		//							"VT_USERDEFINED"
//		//						}));
//		//					case 30:
//		//						return Marshal.PtrToStringAnsi(num1);
//		//					case 64:
//		//						return new DateTime((uint)((int)data1 & -1 | (int)data2));
//		//					case 72:
//		//						return (Guid)UnsafeNativeMethods.PtrToStructure(num1, typeof(Guid));
//		//					default:
//		//						throw new ArgumentException(SR.GetString("COM2UnhandledVT", new object[1]
//		//						{
...
//		//			{
//		//				variant.vt = (short)8;
//		//				variant.data1 = SysAllocString(Convert.ToString(var, (IFormatProvider)CultureInfo.InvariantCulture));
//		//			}
...
//		//			}
//		//			else if (type == typeof(object) || type == typeof(UnsafeNativeMethods.IDispatch) || type.IsCOMObject)
//		//			{
//		//				variant.vt = type == typeof(UnsafeNativeMethods.IDispatch) ? (short)9 : (short)13;
//		//				variant.data1 = Marshal.GetIUnknownForObject(var);
//		//			}
//		//			else
//		//				throw new ArgumentException(SR.GetString("ConnPointUnhandledType", new object[1]
//		//	{
//		//	  (object) type.Name
//		//	}));
//		//		}
...
//		//	private static IntPtr SysAllocString([MarshalAs(UnmanagedType.LPWStr), In] string s);

//		//	[DllImport("oleaut32.dll", CharSet = CharSet.Auto)]
//		//	private static void SysFreeString(IntPtr pbstr);
...
//			{
//				hicon = SafeNativeMethods.CopyImage(new HandleRef((object)icon, icon.Handle), 1, icon.Size.Width, icon.Size.Height, 0);
//			}
//		}
...
//			public int lStructSize { get; set; }
...
//			public short nFromPage { get; set; }

//			public short nToPage { get; set; }

//			public short nMinPage { get; set; }

//			public short nMaxPage { get; set; }

//			public short nCopies { get; set; }
...
//			public WndProc lpfnPrintHook { get; set; }

//			public WndProc lpfnSetupHook { get; set; }

//			public string lpPrintTemplateName { get; set; }

//			public string lpSetupTemplateName { get; set; }
...
//			{
//				if (picType == 1)
//					return (IntPtr)((long)(uint)union2 | (long)union3 << 32);
//				else
//					return IntPtr.Zero;
//			}
//		}
...
//			public override string ToString()
//			{
//				return "[SYSTEMTIME: " + wDay.ToString((IFormatProvider)CultureInfo.InvariantCulture) + "/" + wMonth.ToString((IFormatProvider)CultureInfo.InvariantCulture) + "/" + wYear.ToString((IFormatProvider)CultureInfo.InvariantCulture) + " " + wHour.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ":" + wMinute.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ":" + wSecond.ToString((IFormatProvider)CultureInfo.InvariantCulture) + "]";
//			}
//		}
...
//			public override string ToString()
//			{
//				return "LVITEM: pszText = " + pszText + ", iItem = " + iItem.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ", iSubItem = " + iSubItem.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ", state = " + state.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ", iGroupId = " + iGroupId.ToString((IFormatProvider)CultureInfo.InvariantCulture) + ", cColumns = " + cColumns.ToString((IFormatProvider)CultureInfo.InvariantCulture);
//			}
//		}
...
//			public override string ToString()
//			{
//				return "LVGROUP: header = " + pszHeader.ToString() + ", iGroupId = " + iGroupId.ToString((IFormatProvider)CultureInfo.InvariantCulture);
//			}
//		}
...
//				if (length > -1)
//					return GetPInvokeStringLength(s.Substring(0, length)) + GetEmbeddedNullStringLengthAnsi(s.Substring(length + 1)) + 1;
//				else
//					return GetPInvokeStringLength(s);
//			}

//			[DllImport("kernel32.dll", CharSet = CharSet.Auto)]
//			private static int lstrlen(string s);
//		}
...
//			{
//				return new tagTYPEDESC()
//				{
//					unionMember = (IntPtr)tdescAlias_unionMember,
//					vt = tdescAlias_vt
//				};
//			}
